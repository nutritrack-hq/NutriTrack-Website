        ...
        <div className="min-h-screen bg-white text-gray-900">
            ...
            <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
                ...
                <section className="prose prose-gray mt-6 max-w-none">
                    <h1 className="text-4xl font-bold mb-4">NutriTrack Terms of Service</h1>
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">1. Eligibility</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">2. Account Registration</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">3. App Usage</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">4. Future Subscriptions</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">5. Health Disclaimer</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">6. Third-Party Services</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">7. Data and Privacy</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">9. Termination</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">10. Limitation of Liability</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">11. Dispute Resolution & Arbitration</h2>
                    <p>
