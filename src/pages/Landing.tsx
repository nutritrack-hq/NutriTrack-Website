...
export default function Landing() {
  return (
    <>
      <Helmet>
        <title>NutriTrack — Track Your Nutrition, Build Better Habits</title>
        <meta
          name="description"
          content="NutriTrack helps you log meals, analyze macros, and build better nutrition habits with personalized insights. Simple, privacy-first, and built for real life."
        />
        <link rel="canonical" href="https://www.nutritrack-app.com/" />
        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.nutritrack-app.com/" />
        <meta property="og:title" content="NutriTrack — Track Your Nutrition, Build Better Habits" />
        <meta property="og:description" content="NutriTrack helps you log meals, analyze macros, and build better nutrition habits with personalized insights. Simple, privacy-first, and built for real life." />
        ...
        <meta name="twitter:title" content="NutriTrack — Track Your Nutrition, Build Better Habits" />
        <meta name="twitter:description" content="NutriTrack helps you log meals, analyze macros, and build better nutrition habits with personalized insights. Simple, privacy-first, and built for real life." />
          ...
          {`
            {
              ...
              "logo": "https://www.nutritrack-app.com/logo-green.jpg",
              "description": "NutriTrack helps you log meals, analyze macros, and build better nutrition habits with personalized insights.",
              "sameAs": [
                "https://twitter.com/nutritrack.co",
                "https://www.instagram.com/nutritrack.co"
              ]
            }
          `}
        </script>
        ...
        <section className="mx-auto max-w-7xl px-4 pt-14 sm:px-6 sm:pt-20">
          <div className="grid items-center gap-10 md:grid-cols-2">
            ...
            <div className="relative">
              ...
              <img src="flyer-green.png" className="aspect-[4/3] w-full" alt='nutritrack flyer' />
            </div>
          </div>
        </section>
            ...
            {[
              ...
              >
                <div className="mb-3 h-8 w-8 rounded">
                  <img src="/logo-green.jpg" className="h-8 w-8 rounded" alt="NutriTrack Logo" />
                </div>
