...
export default function Privacy() {
  return (
    <>
      <Helmet>
        <title>Privacy Policy • NutriTrack</title>
        <meta
          name="description"
          content="Learn how NutriTrack collects, uses, and protects your data. We value your privacy—no data selling, full deletion on account removal, and secure storage. Read our Privacy Policy for details."
        />
        <link rel="canonical" href="https://www.nutritrack-app.com/privacy" />
        {/* Open Graph tags */}
        <meta property="og:title" content="Privacy Policy • NutriTrack" />
        <meta property="og:locale" content="en_US" />
        <meta
          property="og:description"
          content="Learn how NutriTrack collects, uses, and protects your data. We value your privacy—no data selling, full deletion on account removal, and secure storage. Read our Privacy Policy for details."
        />
        <meta property="og:url" content="https://www.nutritrack-app.com/privacy" />
        <meta property="og:image" content="https://www.nutritrack-app.com/logo-green.jpg" />
        <meta property="og:type" content="website" />
        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Privacy Policy • NutriTrack" />
        <meta
          name="twitter:description"
          content="Learn how NutriTrack collects, uses, and protects your data. We value your privacy—no data selling, full deletion on account removal, and secure storage. Read our Privacy Policy for details."
        />
        <meta name="twitter:url" content="https://www.nutritrack-app.com/privacy" />
          ...
          {`
            {
              ...
              "@type": "PrivacyPolicy",
              "name": "NutriTrack Privacy Policy",
              "url": "https://www.nutritrack-app.com/privacy",
              "description": "This Privacy Policy explains how NutriTrack collects, uses, and protects your personal data. We do not sell your data and fully delete it upon account removal.",
